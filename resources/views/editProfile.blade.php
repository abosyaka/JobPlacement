                    ...
                    <div class="profile-r-sub-con col-xl-8 pl-lg-5 d-flex flex-col flex-md-row">
                        ...
                        <div class="">
                            <form action="{{route('edit')}}" method="post">
                                ...
                                <div class="form-inline mb-3">
                                    <label for="avatar" class="font-weight-bold" style="font-size: 1.3em;">Avatar</label>
                                    <input type="text" class="form-control ml-2 col" name="avatar" id="avatar"
                                           value="{{$user->avatar}}">
                                </div>
                                <div class="form-inline mb-3">
                                    <label for="spec" class="font-weight-bold" style="font-size: 1.3em;">Specialization</label>
                                ...
                                <div class="form-inline">
                                    <button type="submit" class="btn btn-outline-warning col" style="position: static">Save</button>
                                </div>
                            </form>
                        </div>
                    </div>
